...
radFlavor=Radiobutton(variable=Flavor,text="Americano",value="americano",font="Arial 14",fg="blue",bg="sky blue")
radFlavor.place(x=230,y=200)
radFlavor=Radiobutton(variable=Flavor,text="Espresso",value="espresso",font="Arial 14",fg="blue",bg="sky blue")
radFlavor.place(x=230,y=240)
radFlavor=Radiobutton(variable=Flavor,text="Mocha",value="mocha",font="Arial 14",fg="blue",bg="sky blue")
radFlavor.place(x=230,y=280)
radFlavor=Radiobutton(variable=Flavor,text="Latte",value="latte",font="Arial 14",fg="blue",bg="sky blue")
radFlavor.place(x=230,y=320)
Flavor.set("americano")
